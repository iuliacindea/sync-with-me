        ...
        <div className="space-y-4">
          <div className="flex border-b border-slate-800 gap-6">
            <button
              ...
              className={`pb-3 text-sm font-medium transition-all cursor-pointer ${activeTab === "friends"
            ...
            <button
              ...
              className={`pb-3 text-sm font-medium transition-all cursor-pointer flex items-center gap-2 ${activeTab === "requests"
                  ? "text-indigo-400 border-b-2 border-indigo-500"
                  : "text-slate-400 hover:text-slate-200"
                }`}
            >
